var NativeComponents = (function (exports) {
    ...
    */
    ...
    function Field(name, type, defaultConfig) {
    ...
    function StringField(name, type = 'text', defaultConfig = {}) {
    ...
    function PasswordField(name, defaultConfig) {
    ...
    function NumberField(name, type = 'number', defaultConfig = {}) {
    ...
    function TextAreaField(name, defaultConfig) {
    ...
    function CheckboxField(name, defaultConfig) {
    ...
    function RadioField(name, options, defaultConfig = {}) {
    ...
    function SelectField(name, options, defaultConfig) {
    ...
    function HiddenField(name, defaultConfig) {
    ...
    function FileField(name, type = 'file', defaultConfig = {}) {
    ...
    function DateField(name, defaultConfig) {
    ...
    function TimeField(name, defaultConfig) {
    ...
    function TelField(name, defaultConfig) {
    ...
    function UrlField(name, defaultConfig) {
    ...
    function ColorField(name, defaultConfig) {
    ...
    function RangeField(name, defaultConfig) {
    ...
    function ImageField(name, defaultConfig) {
    ...
    function CheckboxGroupField(name, options, defaultConfig) {
    ...
    function AutocompleteField(name, defaultConfig) {
    ...
    function FieldCollection(name, config) {
    ...
    function Skeleton(type = 'rect', config = {}) {
    ...
    Stepper.prototype.dynamic = function(observableArray) {
        this.$description.steps = observableArray || $$1.array([]);
        return this;
    };
    ...
    function StepperStep(label, config = {}) {
    ...
    function ColumnGroup(title, configs = {}) {
        this.$description = {
            header: title,
            columns: [],
            align: null,
    ...
    ColumnGroup.prototype.buildHeader = function() {
        ...
        return THeadCell$1({ colspan: this.$description.columns.length }, header);
    };

    function DataTable(name, configs) {
    ...
    function Tooltip(target, content, config = {}) {
